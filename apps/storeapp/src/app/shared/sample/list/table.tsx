...
import useExampleStore, { Example } from '@/store/plant/example/example.service';
import { useEffect } from 'react';

export type ListTableDataType = Example;

export default function TableComponent({ list }: { list: Example[] }) {
