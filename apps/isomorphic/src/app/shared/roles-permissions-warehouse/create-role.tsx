...
import { Input, Button, Tooltip, ActionIcon, Title, Switch } from 'rizzui';
...
export default function CreateRole() {
  ...
  const onSubmit: SubmitHandler<CreateRoleInput> = async (data) => {
    ...
    await store.add({
      ...
      name: data.roleName,
      order: store.role.list?.length + 1,
      permissions: {},
  ...
  return (
    ...
    >
      {({ register, control, watch, formState: { errors } }) => {
        const getColor = watch('roleColor') || "#2465FF";
        ...
        return (
          <>
            ...
            <Controller
              ...
              render={({ field: { value, onChange } }) => (
                <Switch
                  ...
                  error={errors.super_admin?.message}
            ...
            <Input
              ...
              error={errors.roleColor?.message}
              suffix={
                <Tooltip
                  size="sm"
