...
const RequestStatus = {
  ...
  "ON THE WAY TO WAREHOUSE": "secondary",
  "DELIVERED": "success",
  get: (status: string) => (RequestStatus as any)[status],
};
...
export const ListColumns = [
  ...
  columnHelper.accessor('status', {
    ...
    cell: ({ row }) => <Badge
      ...
      color={RequestStatus.get(row.original.status)}
    >
      {row.original.status}
    </Badge>,
  }),
  ...
  columnHelper.display({
    ...
    cell: ({
      ...
      <TableRowActionGroup
        deletePopoverTitle="Delete the Request"
        onDelete={() => {
