...
import useStore, { WareHouseInventory } from '@/store/plant/warehouse-inventory-request/warehouse-inventory-request.service';
import { useEffect } from 'react';
export type ListTableDataType = WareHouseInventory;
