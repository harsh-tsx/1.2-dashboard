...
import useStore, { Order } from '@/store/plant/order/order-store-scans-out.service';
...
export default function TableComponent() {
  ...
  useEffect(() => {
    store.get.paginate({ page: state.pagination.pageIndex, size: state.pagination.pageSize, type: "OUT", })
  }, [state.pagination]);
