...
import useStore from '@/store/plant/forecast/forecast.service'
...
const Modalbutton = (props: Props) => {
    ...
    return (
        <ModalButton
            ...
            view={<GlobalSchemaForm<InferType<typeof forecastSchema>> schema={forecastSchema} onSubmitCb={async (data) => {
