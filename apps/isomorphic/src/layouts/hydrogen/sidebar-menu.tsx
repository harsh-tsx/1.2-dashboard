...
import { MenuItem, menuItems } from '@/layouts/hydrogen/menu-items';
...
export function SidebarMenu() {
  ...
  return (
    <div className="mt-4 pb-3 3xl:mt-6">
      {(menuItems as Required<MenuItem>[]).map((item, index) => {
        const ability = buildAbilityFor(data?.user.role, item.moduleId);
